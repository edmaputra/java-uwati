...
<c:url var="tambahUrl" value="/dokter/tambah" />
<c:url var="editUrl" value="/dokter/edit" />
<c:url var="hapusUrl" value="/dokter/hapus" />
<c:url var="dapatkanUrl" value="/dokter/dapatkan" />
<c:url var="daftarUrl" value="/dokter/daftar" />
					...
					<div class="col-md-2 ">
						<security:authorize access="hasAnyRole('ADMIN')">
							<button class="btn btn-primary" data-toggle="modal"
								data-target="#dokter-modal">Dokter Baru</button>
						</security:authorize>
					</div>
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Dokter Baru</h4>
			</div>

			<form:form action="${tambahUrl}" commandName="dokter"
...
<div class="modal fade" id="dokter-modal-edit" tabindex="-1"
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<form:form action="${editUrl}" commandName="dokter"
...
<div class="modal fade" id="dokter-modal-hapus" tabindex="-1"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form:form action="${hapusUrl}" commandName="dokter"
	...
	$(document).ready(function() {
		...
		$(".formTambah").validate({
			...
			submitHandler : function(form) {
				...
				str['spesialis'] = $('#tambahSpesialis').val();
				str['sip'] = $('#tambahSip').val();
		...
		$(".formEdit").validate({
			...
			submitHandler : function(form) {
				var str = {};
				str['id'] = $('#editId').val();
				str['spesialis'] = $('#editSpesialis').val();
