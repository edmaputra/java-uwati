...
<script>
	...
	function setJumlahInputKomposisi(jumlah) {
		...
		for (var i = 1; i <= num; i++) {
			...
			var inputJumlah = $('<input />', {id : "jumlah" + i, name : "jumlah" + i, class : "form-control", placeholder : "Jumlah"});
			var inputHarga = $('<input />', {id : "harga" + i, name : "harga" + i, class : "form-control", placeholder : "Harga"});
			var inputSubtotal = $('<input />', {id : "subtotal" + i, name : "subtotal" + i, class : "form-control", placeholder : "Subtotal", readonly : "readonly"});
