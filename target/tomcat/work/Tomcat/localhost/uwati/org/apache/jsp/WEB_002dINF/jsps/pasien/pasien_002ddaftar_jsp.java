 ...
 * Generated at: 2017-06-18 15:08:54 UTC
...
public final class pasien_002ddaftar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsps/pasien/../../layouts/gritter.jsp", Long.valueOf(1491729162000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div class=\"modal fade\" id=\"pasien-modal-rm\" tabindex=\"-1\" role=\"dialog\"\n");
      out.write("\taria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n");
      out.write("\t<div class=\"modal-dialog modal-lg\">\n");
      out.write("\t\t<div class=\"modal-content\">\n");
      out.write("\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"\n");
      out.write("\t\t\t\t\taria-hidden=\"true\">&times;</button>\n");
      out.write("\t\t\t\t<h4 class=\"modal-title\" id=\"myModalLabel\">Detail dan Rekam\n");
      out.write("\t\t\t\t\tMedis Pasien</h4>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"modal-body\">\n");
      out.write("\t\t\t\t<div class=\"form-panel\">\n");
      out.write("\t\t\t\t\t<h4 class=\"mb\">\n");
      out.write("\t\t\t\t\t\t<i class=\"fa fa-angle-right\"></i> Pasien\n");
      out.write("\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t<form class=\"form-horizontal\">\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Nama\n");
      out.write("\t\t\t\t\t\t\t\t:</label> <label class=\"col-sm-6 control-label\"><strong>Diar\n");
      out.write("\t\t\t\t\t\t\t\t\tResti Andari Winangsih</strong></label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Jenis\n");
      out.write("\t\t\t\t\t\t\t\tKelamin :</label> <label class=\"col-sm-2 control-label\"><strong>Perempuan</strong></label>\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Usia\n");
      out.write("\t\t\t\t\t\t\t\t:</label> <label class=\"col-sm-2 control-label\"><strong>31\n");
      out.write("\t\t\t\t\t\t\t\t\tTh 2 bln</strong></label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Alamat\n");
      out.write("\t\t\t\t\t\t\t\t:</label> <label class=\"col-sm-10 control-label\"><strong>Jalan\n");
      out.write("\t\t\t\t\t\t\t\t\tKol. Soetadji No. 36 Tanjung Selor, Kabupaten Bulungan,\n");
      out.write("\t\t\t\t\t\t\t\t\tKalimantan Utaraaaaaaaaaaaaaaaa</strong></label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Jaminan\n");
      out.write("\t\t\t\t\t\t\t\t:</label> <label class=\"col-sm-3 control-label\"><Strong>BPJS</Strong></label>\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" style=\"text-align: right;\">Nomor\n");
      out.write("\t\t\t\t\t\t\t\t:</label> <label class=\"col-sm-3 control-label\"><strong>1234567890123456</strong></label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<div class=\"form-panel\">\n");
      out.write("\t\t\t\t\t<h4 class=\"mb\">\n");
      out.write("\t\t\t\t\t\t<i class=\"fa fa-angle-right\"></i> Rekam Medis\n");
      out.write("\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-2 \">\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<table class=\"table table-striped table-advance table-hover\"\n");
      out.write("\t\t\t\t\t\tid=\"tabel-rekam-medis\">\n");
      out.write("\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t\t<div id=\"nav-rekam-medis\"></div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\tidentitas : \"Identitas Wajib Diisi\",\n");
  ...
  private boolean _jspx_meth_security_005fauthorize_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/pasien/pasien-daftar.jsp(18,6) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_security_005fauthorize_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      out.write("\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t<a  href=\"#\" data-toggle=\"modal\" data-target=\"#pasien-modal-rm\">Coba</a> -->\n");
      out.write("\t\t\t\t\t\t\t<a href='#' class=\"btn btn-primary\" data-toggle='modal' data-target='#pasien-modal-rm'><i class='fa fa-address-card'></i></a>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t");
    }
  ...
  private boolean _jspx_meth_security_005fauthorize_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/pasien/pasien-daftar.jsp(211,7) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_security_005fauthorize_005f1.setAccess("hasAnyRole('ADMIN','MEDIS')");
    int _jspx_eval_security_005fauthorize_005f1 = _jspx_th_security_005fauthorize_005f1.doStartTag();
    if (_jspx_eval_security_005fauthorize_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<button class=\"btn btn-primary btn-rekam-medis\" data-toggle=\"modal\" data-target=\"#pasien-modal-hapus\">Rekam Medis Baru</button>\n");
      out.write("\t\t\t\t\t\t\t");
    }
