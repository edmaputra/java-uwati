 ...
 * Generated at: 2017-06-09 15:57:14 UTC
...
public final class tindakan_002ddaftar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsps/tindakan/../../layouts/gritter.jsp", Long.valueOf(1491729162000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"kode\" />\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>Tarif/Harga:</label> \n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"tarif\" class=\"form-control\" id=\"tarif\" value=\"0\"/>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"info\"\tclass=\"form-control\" id=\"info\" />\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
